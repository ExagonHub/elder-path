# Elder Path — Phase 1 Development Roadmap

## Overview

| Version | Content | Status |
|---------|---------|--------|
| v0.1 | Core — character, single combat loop | 🔧 In progress |
| v0.2 | Combat system — class-specific actions | ⏳ Pending |
| v0.3 | Items and inventory | ⏳ Pending |
| v0.4 | Equipment system | ⏳ Pending |
| v0.5 | World and exploration | ⏳ Pending |
| v0.6 | NPCs and economy | ⏳ Pending |
| v0.7 | Enemy variety | ⏳ Pending |
| v0.8 | Boss system | ⏳ Pending |
| v0.9 | Zone color system | ⏳ Pending |
...
6. Lore: boss names drawn from Valdris lore

---

### v0.9 — Zone Color System
